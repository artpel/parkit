...
//  parkit
//
//  Created by Arthur Péligry on 13/07/2019.
...
class MapboxTestVC: UIViewController, MGLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let urlMapbox = URL(string: "mapbox://styles/athur/cjy1akqmo0nqk1cmfdrzjwk9a?fresh=true")
    ...
    extension MapboxTestVC: UIGestureRecognizerDelegate {
